...
public abstract class Batiment {
    ...
    // "protected" permet aux classes enfants d'accéder directement à ces variables
    protected String idBatiment;
    protected int nbrNiveaux;

    // Méthodes abstraites : on oblige les enfants à écrire eux-mêmes le code de ces calculs
    public abstract double devisBatiment();
    public abstract double surfaceSolBatiment(); 
    
    // Getter standard pour récupérer le nom du bâtiment
